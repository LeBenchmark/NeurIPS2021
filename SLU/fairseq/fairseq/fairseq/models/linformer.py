...
class LinformerModel(FairseqEncoderDecoderModel):
    """
    Linformer model from `"Linformer: Self-Attention with Linear Complexity (Wang et al., 2020)
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return LinformerEncoder(args, src_dict, embed_tokens)
...
@register_model("linformer_align")
class TransformerAlignModel(LinformerModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        transformer_model = LinformerModel.build_model(args, task)
...
class LinformerEncoder(FairseqEncoder):
    """
    Linformer encoder consisting of *args.encoder_layers* layers. Each layer
...
class LinformerDecoder(FairseqIncrementalDecoder):
    """
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.layers.extend(
            [
                LinformerDecoderLayer(args, no_encoder_attn)
...
@register_model_architecture("linformer_align", "linformer_align")
...
@register_model_architecture("linformer_align", "linformer_wmt_en_de_big_align")
