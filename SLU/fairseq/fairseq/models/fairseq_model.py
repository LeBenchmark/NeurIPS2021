...
class BaseFairseqModel(nn.Module):
    ...
    def get_normalized_probs_scriptable(
        ...
        #print(' - get_normalized_probs_scriptable, net_output shape: {}'.format(net_output.size()))

        if hasattr(self, "decoder"):
            #print(' - get_normalized_probs_scriptable, calling decoder function...')
            return self.decoder.get_normalized_probs(net_output, log_probs, sample)
        elif torch.is_tensor(net_output):
            #print(' - get_normalized_probs_scriptable, interpreting net_output as a tensor...')
