...
class myW2V2LinTanh(nn.Module):
    ## is left undone for now
    def __init__(self, featSize, lastOnly=False, device="cuda", outputSize=1, featPath=""):
        super(myW2V2LinTanh, self).__init__()
        import torchaudio
...
class myGRU_CLS(nn.Module):
    def __init__(self, featSize, hidden_size=128, num_layers=1, device="cuda", lastOnly=True, outputSize=1):
        super(myGRU_CLS, self).__init__()
