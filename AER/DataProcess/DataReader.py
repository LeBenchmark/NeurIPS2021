...
class DataReader():
    ...
    def reUseModelFeat(self, featModel, normalised=False, maxDur=29.98, device="cpu"):
        import fairseq
    ...
    def inputReader(self, ID):
        if self.onlineFeat:
            ...
            if "W2V2" in self.feat or "wav2vec2" in self.feat:
                ...
                inputs = getFeatsFromAudio(fullPath, self.featModel, self.maxDur, self.layerNormed, device=self.device, convOnly=convOnly)
